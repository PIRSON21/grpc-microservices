...
const (
	WarehouseService_GetWarehouseByID_FullMethodName = "/warehouse.WarehouseService/GetWarehouseByID"
)
...
type WarehouseServiceClient interface {
	GetWarehouseByID(ctx context.Context, in *GetWarehouseRequest, opts ...grpc.CallOption) (*WarehouseResponse, error)
}
...
func (c *warehouseServiceClient) GetWarehouseByID(ctx context.Context, in *GetWarehouseRequest, opts ...grpc.CallOption) (*WarehouseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WarehouseResponse)
	err := c.cc.Invoke(ctx, WarehouseService_GetWarehouseByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WarehouseServiceServer interface {
	GetWarehouseByID(context.Context, *GetWarehouseRequest) (*WarehouseResponse, error)
...
func (UnimplementedWarehouseServiceServer) GetWarehouseByID(context.Context, *GetWarehouseRequest) (*WarehouseResponse, error) {
...
func _WarehouseService_GetWarehouseByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarehouseServiceServer).GetWarehouseByID(ctx, req.(*GetWarehouseRequest))
	}
